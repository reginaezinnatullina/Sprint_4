...
public class DropDownParametersTest extends PraktikumBaseTest {
    private final String questionLocator;
    private final String answerLocator;
    private final String answerText;
    /** Конструктор класса*/
    public DropDownParametersTest(String questionLocator, String answerLocator, String answerText) {
    ...
    public void CheckQuestion() {
        ...
        objHomePage.clickQuestionButton(questionLocator);
